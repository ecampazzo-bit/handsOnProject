...
SELECT 'Prestadores totales' as info, COUNT(*) as cantidad FROM public.prestadores
UNION ALL
SELECT 'Prestador-Servicios', COUNT(*) FROM public.prestador_servicios
UNION ALL
SELECT 'Servicios totales', COUNT(*) FROM public.servicios
UNION ALL
SELECT 'Usuarios prestadores', COUNT(*) FROM public.users WHERE tipo_usuario IN ('prestador', 'ambos');
