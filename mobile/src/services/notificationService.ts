...
export const getExpoPushToken = async (): Promise<string | null> => {
  ...
  try {
    ...
    if (
      ...
      console.log(
        "Notificaciones push remotas no disponibles. Usando notificaciones locales."
      );
      return null;
    }
    ...
    if (!isExpoGo) {
      try {
        ...
        if (
          ...
          console.log(
            "Modo Expo Go: Las notificaciones locales funcionarán, pero las push remotas requieren un development build."
          );
        } else {
